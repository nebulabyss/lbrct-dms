<nav class="navbar navbar-expand-md navbar-light bg-light">
    <a class="navbar-brand" href="#">LBRCT <small class="text-muted d-sm-none d-md-inline d-none">Data Management System</small></a>
    ...
    <div class="collapse navbar-collapse mr-auto mt-2 mt-lg-0" id="navbarSupportedContent">
        <span class="navbar-text ml-auto mr-2">Logged is as <span class="navbar-text text-dark" style="font-weight: bold"><?php echo $user?></span></span>
...
<nav>
    <ul class="nav bg-light p-2 border-bottom">
        <li class="nav-item dropdown mr-2">
            <a class="nav-link btn btn-outline-primary dropdown-toggle" data-toggle="dropdown" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Compliance
            </a>
        ...
        <li class="nav-item dropdown mr-2">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#">Add bird count</a>
                <a class="dropdown-item" href="#">Add water quality</a>
                <a class="dropdown-item" href="#">Add marine debris</a>
            </div>
        </li>
