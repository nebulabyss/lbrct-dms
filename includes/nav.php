...
<nav>
    <ul class="nav bg-light p-2 border-bottom">
        ...
        <li class="nav-item dropdown mr-2">
            <a class="nav-link btn btn-outline-success dropdown-toggle" href="#" id="conservation" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Conservation
            </a>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link btn btn-outline-info dropdown-toggle" href="#" id="reports" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Reports
            </a>
